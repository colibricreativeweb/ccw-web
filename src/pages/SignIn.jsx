              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-[#00a6ffff] hover:bg-blue-500 w-full">Sign in</button>
                    </div>
                  </div>
                </form>
                ...
                <div className="text-gray-600 text-center mt-6">
                  Don’t you have an account? <Link to="/quote" className="text-blue-600 hover:underline transition duration-150 ease-in-out">Sign up</Link>
                </div>
              </div>
