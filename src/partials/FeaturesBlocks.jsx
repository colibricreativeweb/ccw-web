        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">We set the schedule with all the specifics from the service and scale.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">You'll approve a wireframe and mockup and we'll start making it real.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">We place the corporate image and products from your project's identity.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">We powerfully code everything up, we boost it and the world is going to see.</p>
            </div>
