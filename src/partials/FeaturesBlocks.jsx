        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">
              No job is too small and no dream is too impossible to achieve, we
              want to hear you!
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <a
              className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl cursor-pointer"
            ...
            >
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">
                Initial Contact <i className="icon-link-ext text-[15px]" />
              </h4>
              <p className="text-gray-600 text-center">
                Wanna know how and when to start? Get to know us on a meeting.
              </p>
            </a>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We detail on the project, activities and tasks, then what's
                going to happen.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We set the schedule with all the specifics from the service and
                scale.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                You'll approve a wireframe and mockup and we'll start making it
                real.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white hover:border-2 hover:border-blue-400 hover:-translate-y-4 duration-300 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We place the corporate image and products from your project's
                identity.
              </p>
            </div>
